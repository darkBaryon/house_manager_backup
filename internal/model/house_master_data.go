...
type HmdBuilding struct {
	...
	ListingFacilities []string      `bson:"listing_facilities" json:"listingFacilities"`
}
...
type HmdRoomTypeCentralized struct {
	...
	DecorationLevel string        `bson:"decoration_level" json:"decorationLevel"`
	PaymentCycle    string        `bson:"payment_cycle" json:"paymentCycle"`
	Rent            int           `bson:"rent" json:"rent"`
	Deposit         int           `bson:"deposit" json:"deposit"`
	ServiceFee      int           `bson:"service_fee" json:"serviceFee"`
	AgencyFeeMode   string        `bson:"agency_fee_mode" json:"agencyFeeMode"`
	AgencyFeeValue  int           `bson:"agency_fee_value" json:"agencyFeeValue"`
	Images          []TaggedImage `bson:"images" json:"images"`
	RoomFacilities  []string      `bson:"room_facilities" json:"roomFacilities"`
}
...
type HmdRoomCentralized struct {
	...
	RentMode          string        `bson:"rent_mode" json:"rentMode"`
	...
	AgencyFeeMode     string        `bson:"agency_fee_mode" json:"agencyFeeMode"`
	AgencyFeeValue    int           `bson:"agency_fee_value" json:"agencyFeeValue"`
	RoomStatus        int           `bson:"room_status" json:"roomStatus"`
	ViewingTimeRule   string        `bson:"viewing_time_rule" json:"viewingTimeRule"`
	StartRentRule     string        `bson:"start_rent_rule" json:"startRentRule"`
	Images            []TaggedImage `bson:"images" json:"images"`
	RoomFacilities    []string      `bson:"room_facilities" json:"roomFacilities"`
	ListingFacilities []string      `bson:"listing_facilities" json:"listingFacilities"`
}
