...
type StaffRepository struct {
	*common.Repository[model.AdmStaff]
}

func NewStaffRepository(client *dbmongo.Client) *StaffRepository {
	return &StaffRepository{
		Repository: common.NewRepository[model.AdmStaff](client.Collection(model.CollectionAdmStaff)),
	}
}

func (r *StaffRepository) Create(ctx context.Context, staff *model.AdmStaff) error {
...
func (r *StaffRepository) FindActiveByPhone(ctx context.Context, phone string) (*model.AdmStaff, error) {
	if phone == "" {
