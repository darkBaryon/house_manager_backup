...
func (p *PublisherProjector) RefreshCentralizedProject(ctx context.Context, projectID bson.ObjectID) error {
	slog.InfoContext(ctx, "listingprojection.publisher.refresh_project.start", "project_id", projectID.Hex())
	...
	slog.InfoContext(ctx, "listingprojection.publisher.refresh_project.fanout", "project_id", projectID.Hex(), "room_count", len(rooms))
...
func (p *PublisherProjector) RefreshBuilding(ctx context.Context, buildingID bson.ObjectID) error {
	slog.InfoContext(ctx, "listingprojection.publisher.refresh_building.start", "building_id", buildingID.Hex())
	...
	slog.InfoContext(ctx, "listingprojection.publisher.refresh_building.fanout", "building_id", buildingID.Hex(), "room_count", len(rooms))
	return p.refreshCentralizedRooms(ctx, rooms)
}

func (p *PublisherProjector) RefreshRoomTypeCentralized(ctx context.Context, roomTypeID bson.ObjectID) error {
	slog.InfoContext(ctx, "listingprojection.publisher.refresh_room_type.start", "room_type_id", roomTypeID.Hex())
	...
	slog.InfoContext(ctx, "listingprojection.publisher.refresh_room_type.fanout", "room_type_id", roomTypeID.Hex(), "room_count", len(rooms))
	return p.refreshCentralizedRooms(ctx, rooms)
}

func (p *PublisherProjector) RefreshDecentralizedCommunity(ctx context.Context, decentralizedID bson.ObjectID) error {
	slog.InfoContext(ctx, "listingprojection.publisher.refresh_community.start", "community_id", decentralizedID.Hex())
	...
	slog.InfoContext(ctx, "listingprojection.publisher.refresh_community.fanout", "community_id", decentralizedID.Hex(), "room_count", len(rooms))
