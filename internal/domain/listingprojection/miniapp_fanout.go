...
func (p *MiniappProjector) RefreshCentralizedProject(ctx context.Context, projectID bson.ObjectID) error {
	logProjectionInfo(ctx, "listingprojection.miniapp.refresh_project.start", "project_id", projectID.Hex())
	...
	logProjectionInfo(ctx, "listingprojection.miniapp.refresh_project.fanout", "project_id", projectID.Hex(), "room_count", len(rooms))
...
func (p *MiniappProjector) RefreshBuilding(ctx context.Context, buildingID bson.ObjectID) error {
	logProjectionInfo(ctx, "listingprojection.miniapp.refresh_building.start", "building_id", buildingID.Hex())
	...
	logProjectionInfo(ctx, "listingprojection.miniapp.refresh_building.fanout", "building_id", buildingID.Hex(), "room_count", len(rooms))
	return p.refreshCentralizedRooms(ctx, rooms)
}

func (p *MiniappProjector) RefreshRoomTypeCentralized(ctx context.Context, roomTypeID bson.ObjectID) error {
	logProjectionInfo(ctx, "listingprojection.miniapp.refresh_room_type.start", "room_type_id", roomTypeID.Hex())
	...
	logProjectionInfo(ctx, "listingprojection.miniapp.refresh_room_type.fanout", "room_type_id", roomTypeID.Hex(), "room_count", len(rooms))
	return p.refreshCentralizedRooms(ctx, rooms)
}

func (p *MiniappProjector) RefreshDecentralizedCommunity(ctx context.Context, decentralizedID bson.ObjectID) error {
	logProjectionInfo(ctx, "listingprojection.miniapp.refresh_community.start", "community_id", decentralizedID.Hex())
	...
	logProjectionInfo(ctx, "listingprojection.miniapp.refresh_community.fanout", "community_id", decentralizedID.Hex(), "room_count", len(rooms))
